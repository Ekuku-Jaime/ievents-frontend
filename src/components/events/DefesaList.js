...
export default function DefesaList({ events, deleteEvent }) {
  const [openPopup, setOpenPopup] = useState(false);
  const [eventId, setEventId] = useState(null);

  const defesaEvents = events.filter((evento) => evento.type === 'Defesa');
  ...
  const columns = [
    ...
    { title: 'Nome do estudante', field: 'student_name' },
